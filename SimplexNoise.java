...
public class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
  ...
  public static double noise(double xin, double yin) {
    ...
    double t = (i+j)*G2;
    double xInitial = i-t; // Unskew the cell origin back to (x,y) space
    double yInitial = j-t;
    double x0 = xin-xInitial; // The x,y distances from the cell origin
    double y0 = yin-yInitial;
  ...
  public static double noise(double xin, double yin, double zin) {
    ...
    double t = (i+j+k)*G3;
    double xInitial = i-t; // Unskew the cell origin back to (x,y,z) space
    double yInitial = j-t;
    double zInitial = k-t;
    double x0 = xin-xInitial; // The x,y,z distances from the cell origin
    double y0 = yin-yInitial;
    double z0 = zin-zInitial;
  ...
  public static double noise(double x, double y, double z, double w) {
    ...
    double xInitial = i - t; // Unskew the cell origin back to (x,y,z,w) space
    double yInitial = j - t;
    double zInitial = k - t;
    double wInitial = l - t;
    double x0 = x - xInitial;  // The x,y,z,w distances from the cell origin
    double y0 = y - yInitial;
    double z0 = z - zInitial;
    double w0 = w - wInitial;
